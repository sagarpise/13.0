...
class WebsiteBrandSearch(WebsiteSale):
    ...
    def shop(self, page=0, category=None, search='', ppg=False, **post):
        ...
        keep = QueryURL('/shop', category=category and int(category), search=search, attrib=attrib_list, brand = brand_set , order=post.get('order'))
