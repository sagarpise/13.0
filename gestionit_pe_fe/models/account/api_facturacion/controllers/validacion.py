...
fields_required = {'tipoDocumento': ' Es necesario el tipo de Documento a enviar.',
                   'fechaEmision': ' Es necesaria la Fecha de Emisión.',
                   #'idTransaccion': ' Es necesario el ID de la transacción.',
...
fields_required_doc_fac_bol = {'serie': ' Es necesario la serie del documento con formato (AXXX).',
                               ...
                               'nombreEmisor': ' Es necesario el nombre del Emisor del Documento.',
                               'tipoDocEmisor': ' Es necesario el tipo del documento del Emisor ("1","6").',
                               'numDocEmisor': ' Es necesario el número de documento del Emisor.',
                               'tipoDocReceptor': ' Es necesario el tipo de documento del Recepto ("1","6").',
                               'numDocReceptor': ' Es necesario el número de documento del Receptor.',
                               'nombreReceptor': ' Es necesario el nombre del Receptor del Documento.',
                               'tipoMoneda': ' Es necesario el tipo de moneda (Por ejemplo: PEN, USD, etc.).',
                               'mntTotal': ' Es necesario el monto Total del documento.',
                               }

fields_required_doc_note = {'serie': ' Es necesario la serie del documento con formato (AXXX).',
                            'correlativo': ' Es necesario el correlativo del documento.',
                            'nombreEmisor': ' Es necesario el nombre del Emisor del Documento.',
                            'tipoDocEmisor': ' Es necesario el tipo del documento del Emisor ("1","6").',
                            'numDocEmisor': ' Es necesario el número de documento del Emisor.',
                            ...
                            'tipoMoneda': ' Es necesario el tipo de moneda (Por ejemplo: PEN, USD, etc.).',
                            'mntTotal': ' Es necesario el monto Total del documento.',
                            'tipoMotivoNotaModificatoria': ' Es necesario el tipo de Motivo de la Nota de Crédito o Débito.',
                            }

fields_required_detalle_fac_bol = {'cantidadItem': ' Es necesario la cantidad de Item\'s.',
                                   'unidadMedidaItem': ' Es necesaria la unidad de Medida del Item.',
                                   'nombreItem': ' Es necesario el nombre del Item.',
                                   'precioItem': ' Es necesario el precio del Item.',
                                   'precioItemSinIgv': ' Es necesario el precio sin IGV del Item.',
                                   'montoItem': ' Es necesario el monto total del Item.',
                                   'codAfectacionIgv': ' Es necesario el Código de Afectación IGV del Item.',
                                   'idOperacion': ' Es necesario el ID de Operación.', }

fields_required_detalle_note = {'idOperacion': ' Es necesario el ID de Operación.'}

fields_required_referencia_note = {'tipoDocumentoRef': ' Es necesario el tipo de Documento de Referencia de la Nota.',
                                   'serieRef': 'Es necesario la serie (AXXX) del Documento de Referencia de la Nota.',
                                   'correlativoRef': ' Es necesario el correlativo del Documento de Referencia de la Nota.',
                                   'fechaEmisionRef': 'Es necesaria la Fecha de Emisión del Documento de Referencia de la Nota.'}

fields_required_summaries = {'tipoResumen': ' Es necesario el tipo de Resumen (RA, RC).',
                             'fechaGeneracion': ' Es necesaria la fecha de Generación del Resumen.',
...
fields_required_summaries_resumen = {'id': ' Es necesario el ID del Resumen.',
                                     ...
                                     'numDocEmisor': ' Es necesario el Número del Documento de Emisor.',
                                     'nombreEmisor': ' Es necesario el nombre del Emisor del Resumen.',
                                     'fechaReferente': ' Es necesaria la fecha Referente del Resumen.'}

fields_required_detalle_summaries = {'serie': ' Es necesario la serie del Detalle del Resumen.',
                                     'motivo': ' Es necesario el motivo del Detalle del Resumen.',
                                     'tipoDocumento': ' Es necesario el tipo de Documento del Detalle del Resumen.',
                                     'correlativo': ' Es necesario el correlativo del Detalle del Resumen.'}

fields_required_detalle_summaries_rc = {'serie': ' Es necesario la serie del documento con formato (AXXX).',
                                        'correlativo': ' Es necesario el correlativo del documento.',
                                        'tipoDocumento': ' Es necesario el tipo de Documento del Detalle del Resumen.',
                                        'tipoDocReceptor': ' Es necesario el tipo de documento del Receptor ("1","6").',
                                        'numDocReceptor': ' Es necesario el número de documento del Receptor.',
                                        'tipoMoneda': ' Es necesario el tipo de moneda (Por ejemplo: PEN, USD, etc.).',
                                        'codAfectacionIgv': ' Es necesario el Código de Afectación IGV del Item.',
                                        'mntIgv': ' Es necesario el monto del IGV del detalle del Documento.',
                                        'mntIsc': ' Es necesario el monto del ISC del detalle del Documento.',
                                        'codOperacion': ' Es necesario el código de Operación.'}

fields_required_guiaremision = {'tipoDocumento': ' Es necesario el tipo de Documento a enviar.',
                                'fechaEmision': ' Es necesaria la Fecha de Emisión.',
                                'idTransaccion': ' Es necesario el ID de la transacción.',
                                'correoReceptor': 'Es necesario el correo del receptor del documento.',
                                'documento': ' Es necesario información del documento a enviar.',
...
fields_required_doc_guiaremision = {'serie': ' Es necesario la serie del documento con formato (AXXX).',
                               ...
                               'numDocReceptor': ' Es necesario el número de documento del Receptor.',
                               'nombreReceptor': ' Es necesario el nombre del Receptor del Documento.',
                                'direccionOrigen': 'Es necesario la dirección origen',
                                    'direccionUbigeo': 'Es necesario el ubigeo',
                               }

fields_required_detalle_guiaremision = {'cantidadItem': ' Es necesario la cantidad de Item\'s.',
                                   'unidadMedidaItem': ' Es necesaria la unidad de Medida del Item.',
                                   'nombreItem': ' Es necesario el nombre del Item.',
                                        'codItem': ' Es necesario el ID de producto.',

}


datos_impuestos_sunat = {'1000': {'id': 'S', 'code': 'VAT', 'name': 'IGV'},
                         '2000': {'id': 'S', 'code': 'EXC', 'name': 'ISC'},
                         '9996': {'id': 'Z', 'code': 'FRE', 'name': 'GRATUITO'},
                         '9997': {'id': 'E', 'code': 'VAT', 'name': 'EXONERADO'},
                         '9998': {'id': 'O', 'code': 'FRE', 'name': 'INAFECTO'},
                         '9999': {'id': 'S', 'code': 'OTH', 'name': 'OTROS'}}

# DATOS TEMPORALES
sunat_usuario = "ATORTLEN"
sunat_password = "roofietum"
key_prviate = "-----BEGIN RSA PRIVATE KEY-----\n" \
              "MIIEpAIBAAKCAQEA7kRbym0bA3zGMNlqqRW7Pv6qJr4defIK+8sr480xnHZJZ9S7\n" \
              "ileIrxgyFa6bXXKANkAmHI0WKux4F2uFtvut4FTwkXq4rb5/L7gBoZdptg+uTKX7\n" \
              "cHVeonTAybPge0I23G7OsL+lBD8TIi0rMudhocgYXpwCS5jyLpCX4lsV/miPsJdb\n" \
              "gjF3AaFdXGr7KQfR42X3IXbyOX7JnqtB2tK1GNES8i1GhW5JXGnhHQjZ46lysmXA\n" \
              "sVPwCxL/wRrUfTFJcgAQ93sQGZAF1hFGdzXvnEMCJINl6JjnCDOyllhH3EarXxdR\n" \
              "VkSONzvDd5jxouThzZUWszsis376MVbNn9dqgwIDAQABAoIBAFzU6WZ/B+1d6eIS\n" \
              "c4oZW3D5y9V4cQeYFEtyJ1GEGvY45/S6X69Q14JQzQLBmurXt7hrWe350k86/rcx\n" \
              "P1HB0Ub8ERa9V8Lp26f96zTIR3mVtnVKniJ8uDhXgN2VZbrgW3ua+JDIukRjRtMk\n" \
              "Aha9K77atRP3eLV3i7Q0xdh9YJ5T4mLm80Wn73rZDMA5Ss5jpS4LAKhgaBUCN0rV\n" \
              "W5XM5KjNOGDfbGyzaGr2STkEP/JElcNPaB657qUQPn5b6jcaBM71iJxaOJv2gZIt\n" \
              "ZZdLZnls2b7KMirlv22bG/8X4k8GrghxMxPYMDfpur+mo8nNlXPfxnoHGsqEvnqo\n" \
              "8FprutECgYEA+PtH15ZTzvMb6xY2UUDLZKnlV8TYESYCCWlhmXksO5kNS6sDkD0B\n" \
              "EJzFTCcmdlnRk84sPzNz7+cmVTV9KjvWVmgvr1dnLGKY1LuoGtDKMjdDlApFLifG\n" \
              "17q1GlF/HxaYAbNQtVUYHZ6wfcfZdtCcHE+6/Su0YNouhyOkV0yLOgUCgYEA9PvC\n" \
              "RPkWfdwvq1QfBIEBYPTDbX/cX4cpnQwI7To0LOJ13aJ69/NzAWHVgZPWOlO36G/p\n" \
              "vvLla7pNpACiK8JOLWYmC+fLVTSZLJCLs6yBsuEQe3sIfVyaX3nSy71XEeJThGdY\n" \
              "2enrxcEhEmFkXthJOFVGalwZPyfchUQ0FhVq0OcCgYEAnHB2cXUY750823c3ZdJK\n" \
              "edNuMLmT8SJqgTNfiajjLAc8nWC0enp6Is/9/51Rw2coEbCniIZxwDkCkuNq45B5\n" \
              "Wg1YeNl4ECFbWb8XHtI1WVvz8B6L3TZM79t2UzUFpKjzlY3vliADaQj+Z+mcL9Vf\n" \
              "YUKPgOdnDLvKJEs2xUto52kCgYEAhGgxxo+ODXZdOU9c+FU1Ro7jtSH/HI5z+lKP\n" \
              "3I+xtXSsWZ7AsZSd2uhiugcKKTooUvNxtWeYgdIOto41GEuLb1QfSh38ss+b3g89\n" \
              "wl2BOAoWm3aSzxamxOWV/dIW5i6aDxzAU/7vFFHeqw2CbxSc9lp4lXGzn4PO1yRW\n" \
              "tnza348CgYB7/ZHwvQg2NStTrnT0Llk40GDNt3LFGBX+nGMxu81sG26V5+uyinAL\n" \
              "3IPVtEjSgEaus6iIP8Ki59D8HdwgTAaYhnYAUjfw5x57h4q54Wva0kvZalMohEd5\n" \
              "7e7H5+lsEVcSEFckouwrrV4an94nlIQH+fEmqL0eW9qffaB+6uy+Ew==\n" \
              "-----END RSA PRIVATE KEY-----\n"

key_public = "-----BEGIN CERTIFICATE-----\n" \
             "MIIIITCCBwmgAwIBAgIJTfRTAAAAYChwMA0GCSqGSIb3DQEBCwUAMIG4MQswCQYD\n" \
             "VQQGEwJFUzElMCMGCSqGSIb3DQEJARYWY2FyYWNlckBjYW1lcmZpcm1hLmNvbTFD\n" \
             "MEEGA1UEBxM6TWFkcmlkIChzZWUgY3VycmVudCBhZGRyZXNzIGF0IHd3dy5jYW1l\n" \
             "cmZpcm1hLmNvbS9hZGRyZXNzKTESMBAGA1UEBRMJQTgyNzQzMjg3MRkwFwYDVQQK\n" \
             "ExBBQyBDYW1lcmZpcm1hIFNBMQ4wDAYDVQQDEwVSQUNFUjAeFw0xNzEyMTgxNDQ3\n" \
             "MjNaFw0xODEyMTgxNDQ3MjNaMIIBujEpMCcGCSqGSIb3DQEJARYabWFudWVsLmZp\n" \
             "Z3Vlcm9hQG1pbmR0ZWMucGUxMjAwBgNVBA0MKVF1YWxpZmllZCBDZXJ0aWZpY2F0\n" \
             "ZTogUkFDRVItUEZWUC1TVy1LUFNDMRMwEQYDVQQHDApNSVJBRkxPUkVTMRIwEAYD\n" \
             "VQQIDAlMSU1BLUxJTUExEjAQBgNVBAUTCTQ1NDIyMDkxMDETMBEGCisGAQQBgYcu\n" \
             "HgIMA1JVQzEbMBkGCisGAQQBgYcuHgMMCzIwNjAwNzExNDI0MRMwEQYKKwYBBAGB\n" \
             "hy4eBAwDRE5JMS0wKwYDVQQKDCRTT0xVQ0lPTkVTIFRFQ05PTE9HSUNBUyBNICYg\n" \
             "TSBTLkEuQy4xETAPBgNVBAsMCEdFUkVOQ0lBMRQwEgYDVQQLDAsyMDYwMDcxMTQy\n" \
             "NDEYMBYGA1UEDAwPR0VSRU5URSBHRU5FUkFMMRcwFQYDVQQEDA5GSUdVRVJPQSBI\n" \
             "T0NFUzEWMBQGA1UEKgwNTUFOVUVMIEFET0xGTzElMCMGA1UEAwwcTUFOVUVMIEFE\n" \
             "T0xGTyBGSUdVRVJPQSBIT0NFUzELMAkGA1UEBhMCUEUwggEiMA0GCSqGSIb3DQEB\n" \
             "AQUAA4IBDwAwggEKAoIBAQDuRFvKbRsDfMYw2WqpFbs+/qomvh158gr7yyvjzTGc\n" \
             "dkln1LuKV4ivGDIVrptdcoA2QCYcjRYq7HgXa4W2+63gVPCReritvn8vuAGhl2m2\n" \
             "D65MpftwdV6idMDJs+B7Qjbcbs6wv6UEPxMiLSsy52GhyBhenAJLmPIukJfiWxX+\n" \
             "aI+wl1uCMXcBoV1cavspB9HjZfchdvI5fsmeq0Ha0rUY0RLyLUaFbklcaeEdCNnj\n" \
             "qXKyZcCxU/ALEv/BGtR9MUlyABD3exAZkAXWEUZ3Ne+cQwIkg2XomOcIM7KWWEfc\n" \
             "RqtfF1FWRI43O8N3mPGi5OHNlRazOyKzfvoxVs2f12qDAgMBAAGjggMnMIIDIzAM\n" \
             "BgNVHRMBAf8EAjAAMBEGCWCGSAGG+EIBAQQEAwIFoDAOBgNVHQ8BAf8EBAMCBsAw\n" \
             "HQYDVR0lBBYwFAYIKwYBBQUHAwIGCCsGAQUFBwMEMB0GA1UdDgQWBBSWkGLhq46w\n" \
             "8LA5+FPmyuNNvdOkVjBtBggrBgEFBQcBAQRhMF8wNQYIKwYBBQUHMAKGKWh0dHA6\n" \
             "Ly93d3cuY2FtZXJmaXJtYS5jb20vY2VydHMvcmFjZXIuY3J0MCYGCCsGAQUFBzAB\n" \
             "hhpodHRwOi8vb2NzcC5jYW1lcmZpcm1hLmNvbTCB8wYDVR0jBIHrMIHogBS+vAjU\n" \
             "LroATIDcJme0pdjdw0oa+aGBzKSByTCBxjELMAkGA1UEBhMCRVMxKzApBgkqhkiG\n" \
             "9w0BCQEWHGFjX2NhbWVyZmlybWFAY2FtZXJmaXJtYS5jb20xEjAQBgNVBAUTCUE4\n" \
             "Mjc0MzI4NzFDMEEGA1UEBxM6TWFkcmlkIChzZWUgY3VycmVudCBhZGRyZXNzIGF0\n" \
             "IHd3dy5jYW1lcmZpcm1hLmNvbS9hZGRyZXNzKTEZMBcGA1UEChMQQUMgQ2FtZXJm\n" \
             "aXJtYSBTQTEWMBQGA1UEAxMNQUMgQ2FtZXJmaXJtYYIBATBkBgNVHR8EXTBbMCug\n" \
             "KaAnhiVodHRwOi8vY3JsLmNhbWVyZmlybWEuY29tL3JhY2VyX2YuY3JsMCygKqAo\n" \
             "hiZodHRwOi8vY3JsMS5jYW1lcmZpcm1hLmNvbS9yYWNlcl9mLmNybDAhBgNVHRIE\n" \
             "GjAYgRZjYXJhY2VyQGNhbWVyZmlybWEuY29tMCUGA1UdEQQeMByBGm1hbnVlbC5m\n" \
             "aWd1ZXJvYUBtaW5kdGVjLnBlMGwGA1UdIARlMGMwYQYNKwYBBAGBhy4KCAIBATBQ\n" \
             "MCkGCCsGAQUFBwIBFh1odHRwczovL3BvbGljeS5jYW1lcmZpcm1hLmNvbTAjBggr\n" \
             "BgEFBQcCAjAXDBVRdWFsaWZpZWQgQ2VydGlmaWNhdGUwLwYIKwYBBQUHAQMEIzAh\n" \
             "MAgGBgQAjkYBATAVBgYEAI5GAQIwCxMDRVVSAgEAAgEBMA0GCSqGSIb3DQEBCwUA\n" \
             "A4IBAQAP97OFC4UcDWnUaVRzUsPvX9Md5Ln24C16MsM6q/nEvFORq8vTYDTWeJ3W\n" \
             "O56luatwnd0ij17y4aYOaqnoifH6asZze712EwvByUI8dSl5TTVETTl93DjdOUd6\n" \
             "wS4g0k+rbQP28tH7/XMLutiIJ8rkQLanLLgX99CuZDhraH330kVhBIg169Rnky4R\n" \
             "ODcvziTp+McgWMhLK3hdnNt6obUuumtiCM17d6CZnMg7cwxQZuWc2TxdsxaIcLxp\n" \
             "AZKyTrbxqSyAQouM2TrB8b5EUB3hVRTyc1lfkcoMnLDCFb8Lkmgvl8jOTd0wzSTR\n" \
             "1d/h8Jg5IBXMlPAPpLd0RVw/aqZt\n" \
             "-----END CERTIFICATE-----\n"
...
ubigeo_list = {
    ...
    "050116": ["Ayacucho", "Huamanga", "Andrés Avelino Cáceres Dorregay"],
    ...
    "120699": ["Junin", "Satipo", "Mazamari-Pangoa"],
    ...
    "120908": ["Junin", "Chupaca", "3 de Diciembre"],
    ...
    "150121": ["Lima", "Lima", "Pueblo Libre (Magdalena Vieja)"],
    ...
    "190108": ["Pasco", "Pasco", "San Fco. de Asís de Yarusyacán"],
    ...
    "200115": ["Piura", "Piura", "Veintiséis de Octubre"],
    ...
    "230110": ["Tacna", "Tacna", "Coronel Gregorio Albarracín L"],
    ...
    "999999": ["Extranjero", "Extranjero", "Extranjero"],
}


def validar_tipoDoc(tipoDoc):
    return tipoDoc in ['0', '1', '4', '6', '7', 'A','-']


def validar_correo(correo):
    # return re.match('^[(a-z0-9\_\-\.)]+@[(a-z0-9\_\-\.)]+\.[(a-z)]{2,15}$', correo.lower())
    return correo


def transformar_fecha(fecha):
    try:
        fecha_form = datetime.datetime.strptime(fecha, "%Y-%m-%d")
        fecha_form_str = fecha_form = fecha_form.strftime("%Y-%m-%d")
        return fecha_form_str
    except ValueError:
        return False
